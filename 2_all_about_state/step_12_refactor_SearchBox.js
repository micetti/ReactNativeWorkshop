  ...
  <View>
    ...
    <View style={styles.inputBorders}>
      <Picker
        ...
        onValueChange={(itemValue, itemIndex) => props.onTypePicked(itemValue)}
        mode={'dropdown'}
    ...
    <View style={styles.inputBorders}>
      <TextInput
        ...
        maxLength={2}
        onChangeText={(text) => props.onNumberEntered(text)}
        value={props.number}
...
export default class App extends React.Component {
  constructor(props) {
    ...
    this.setEnteredNumber = this.setEnteredNumber.bind(this);
    this.setPickedType = this.setPickedType.bind(this);
  };
    ...
    return (
      <View style={styles.app}>
        <SearchBox
          ...
          onNumberEntered={this.setEnteredNumber}
          onTypePicked={this.setPickedType}
